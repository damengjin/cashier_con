    ...
    methods: {
        ...
        pad_submit () {
            ...
            //Card: pad used for key in the change returned to customer:
                ...
                this.accum_earn_tran2 = Math.round((this.accum_earn_tran2 +  0.03)*1000)/1000;
        ...
        next (submit=true) {
            ...
            //finish all the 200 questions
            if (this.current === (this.round-1)) {
                //this.earn_stage = Math.round((0.1 * this.correct_num) * 100)/100;
                localStorage.setItem("earn2", this.accum_earn_tran2);
                alert('You have finished all the 200 transactions! Stage 3 ends.');
                window.location = 'Wait_page2.html';
        ...
        onSubmit () {
            ...
            this.accum_earn_tran2 = Math.round((this.accum_earn_tran2 + (this.currentCorrect * 0.03) + (this.currentWrong * 0))*1000)/1000;
            this.next();
        },
